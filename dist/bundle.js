	...
	return A2(
		...
		_elm_lang$core$List$maximum(
			A2(
				_elm_lang$core$List$map,
				function (row) {
					return _elm_lang$core$List$length(row);
				},
				levelData)));
};
		...
		return _elm_lang$core$List$isEmpty(
			A2(
				...
				A2(
					_elm_lang$core$List$map,
					function (position) {
						return A2(_elm_lang$core$List$member, position, _p2.map.boxes);
					},
					_p2.map.target)));
	} else {
		return false;
	...
	function (layer, position) {
		return !_elm_lang$core$List$isEmpty(
			A2(
				_elm_lang$core$List$filter,
				function (square) {
					return _elm_lang$core$Native_Utils.eq(square.x, position.x) && _elm_lang$core$Native_Utils.eq(square.y, position.y);
				},
				layer));
	});
var _user$project$Game$extractMovementMap = function (map) {
	return A2(
		_elm_lang$core$List$filter,
		function (floor) {
			return !A2(_elm_lang$core$List$member, floor, map.boxes);
		},
		map.floor);
};
...
var _user$project$Style$menu = _elm_lang$html$Html_Attributes$style(
	{
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'top', _1: '240px'},
			_1: {
				ctor: '::',
	...
	switch (_p0.ctor) {
		...
		case 'Down':
			return A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(180),
					'deg)'));
		case 'Left':
			return A2(
				_elm_lang$core$Basics_ops['++'],
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(-90),
					'deg)'));
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
			...
			_user$project$Style$baseSquare(position),
			{
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: '-webkit-box-shadow', _1: '1px 1px 1px 0px rgba(0,0,0,0.25)'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: '-moz-box-shadow', _1: '1px 1px 1px 0px rgba(0,0,0,0.25)'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: '1px 1px 1px 0px rgba(0,0,0,0.25)'},
									_1: {ctor: '[]'}
								}
							}
						}
	...
	return _elm_lang$html$Html_Attributes$style(
		A2(
			...
			_user$project$Style$baseSquare(position),
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'background-image', _1: 'url(\'../dist/assets/floor.jpg\')'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'background-size', _1: '100% 100%'},
						_1: {ctor: '[]'}
	...
	return _elm_lang$html$Html_Attributes$style(
		A2(
			...
			_user$project$Style$baseSquare(position),
			{
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'background-image', _1: 'url(\'../dist/assets/wall.png\')'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'background-size', _1: '100% 100%'},
						_1: {
